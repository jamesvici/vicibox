...
An alternative to this is the mostly automated :ref:`express` install. This actually runs the same program but with pre-defined settings. It is an all-in-one approach to ViciDial that can later be turned into a cluster if needed.
...
.. attention::
   It is highly recommended to :ref:`phase1_5-install-updates` before continuing.
